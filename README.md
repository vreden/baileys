...
Baileys and its maintainers cannot be held liable for misuse of this application, as stated in the [MIT license](https://github.com/vreden/baileys/blob/master/LICENSE).
...
Thank you to [@vreden](https://wa.me/6287824695047) for writing his observations on the workings of WhatsApp Multi-Device. Also, thank you to [@Sigalor](https://github.com/sigalor/whatsapp-web-reveng) for writing his observations on the workings of WhatsApp Web and thanks to [@Rhymen](https://github.com/Rhymen/go-whatsapp/) for the __go__ implementation.
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@vreden/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@vreden/baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@vreden/baileys'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@vreden/baileys'
                                */
...
import { downloadMediaMessage } from '@vreden/baileys'
