...
import { areJidsSameUser, isJidBroadcast, isJidGroup, isJidMetaAI, isJidNewsletter, isJidStatusBroadcast, isLidUser, isPnUser, transferDevice, jidNormalizedUser } from '../WABinary/index.js';
...
export function decodeMessageNode(stanza, meId, meLid) {
    ...
    const fromMe = (isLidUser(from) ? isMeLid : isMe)((participant || stanza.attrs.from));
    ...
    const key = {
        ...
        participant_lid: jidNormalizedUser(participant_lid),
